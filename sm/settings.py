...
# Hosts/domain names that are valid for this nm; required if DEBUG is False
...
MEDIA_ROOT = '' # os.path.join(PROJECT_PATH, 'media/')  # os.path.join(PROJECT_PATH, 'media/')
...
SECRET_KEY = 'n=6oo%6i2g#vjzbk3pc5(x(a=+1h8q)jkyqt-4ppw6kn^zmxao'
...
# the nm admins on every HTTP 500 error when DEBUG=False.
